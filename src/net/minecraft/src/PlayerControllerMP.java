...
public class PlayerControllerMP
{
    ...
    // ==== Begin modified code
    public static final PlayerControllerHooks playerControllerHooks = new PlayerControllerHooks();
    // ==== End modified code
    ...
    {
        // ==== Begin modified code
        if (!playerControllerHooks.dispatchBlockClickEvent(true, par1, par2, par3, par4)) {
            return;
        }
        // ==== End modified code
        if (!this.currentGameType.isAdventure())
    ...
    {
        // ==== Begin modified code
        if (!playerControllerHooks.dispatchBlockDamageEvent(par1, par2, par3, par4)) {
            return;
        }
        // ==== End modified code
    ...
    {
        // ==== Begin modified code
        if (!playerControllerHooks.dispatchBlockClickEvent(false, par4, par5, par6, par7)) {
            return false;
        }
        // ==== End modified code
        this.syncCurrentPlayItem();
    ...
    {
        // ==== Begin modified code
        if (!playerControllerHooks.dispatchEntityClickEvent(true, par2Entity)) {
            return;
        }
        // ==== End modified code
        this.syncCurrentPlayItem();
    ...
    {
        // ==== Begin modified code
        if (!playerControllerHooks.dispatchEntityClickEvent(false, par2Entity)) {
            return false;
        }
        // ==== End modified code
        this.syncCurrentPlayItem();
